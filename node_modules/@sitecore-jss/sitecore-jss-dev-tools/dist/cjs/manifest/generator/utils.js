...
exports.validateFieldDefinitions = exports.findTemplateForComponent = exports.findTemplate = exports.findComponentForTemplate = exports.findComponent = exports.checkUnique = exports.convertComponentDataToFields = exports.filterObject = void 0;
/**
...
function validateFieldDefinitions(fields, template, handleError, ...inheritedTemplates) {
    ...
    return exports.filterObject(fields, (fieldName) => {
