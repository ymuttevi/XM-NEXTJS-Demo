...
export const replaceConfigTokens = (val) => {
    ...
    if (newVal.indexOf('{sitecoreInstancePath}') > -1 && !config.sitecore.instancePath) {
        throw new Error(`instancePath config variable was used but was undefined or empty. You likely need to run npm run setup or update your ${userConfigPath}`);
    }
