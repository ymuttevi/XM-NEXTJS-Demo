...
export const describe = 'Generates a JSS manifest file which defines app assets to import into Sitecore. Nothing is deployed or added to a deployment package; this just collects assets. See `jss package`, which takes the manifest and turns it into a deployable package. `jss manifest --help` for options.';
...
export function handler(argv) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (argv.wipe && !argv.unattendedWipe) {
            ...
            if (!readlineSync.keyInYN(chalk.yellow('This will delete any content changes made in Sitecore'))) {
                process.exit(1);
            }
        }
        const generateArgs = {
